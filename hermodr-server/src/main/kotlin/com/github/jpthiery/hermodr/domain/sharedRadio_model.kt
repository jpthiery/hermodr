...
@RegisterForReflection
data class ValidateMusicToSharedRadio(override val id: SharedRadioId, val musicId: MusicId, val title: String, val scheme: MusicScheme, val location: String) : SharedRadioCommand()
